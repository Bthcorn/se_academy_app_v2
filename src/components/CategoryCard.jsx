...
const CategoryCard = ({ icon, title, number }) => {
  return (
    <div className="group flex w-full items-center justify-between gap-2 rounded-md border bg-secondary p-2 duration-200 hover:scale-105 hover:bg-secondary-color4 sm:min-h-48 sm:w-48 sm:flex-col sm:p-4">
