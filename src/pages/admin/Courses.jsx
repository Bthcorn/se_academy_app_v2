...
export default function Courses() {
  const sampleCourses = [
    ...
    },
    {
      ...
      subjectID: 'WEB102',
      year: '2023',
      course_image: 'https://images.unsplash.com/photo-1531497865144-0464d74701b7?ixid=2yJhcHBfaWQiOjEyMDd9&fm=jpg&q=80',
      rating: 4.8,
      duration: 25,
      course_status: 'Available',
      description: 'An introductory course to Node.js covering server-side JavaScript development.',
      capacity: 120,
      video_quantity: 18,
      lecturer: 'Jane Smith',
      category_id: 'DEV102',
      ...
      quiz: [
        {
          ...
          options: [
            ...
            { id: 3, text: 'Server-side development' },
            { id: 4, text: 'UI design' }
          ]
        }
      ],
      correctAnswers: [
        { id: 1, text: 'Server-side development', answer: 3 }
      ]
    },
    {
      course_id: 'C103',
      ...
      subjectID: 'JS301',
      year: '2022',
      course_image: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixid=2yJhcHBfaWQiOjEyMDd9&fm=jpg&q=80',
      rating: 4.9,
      duration: 30,
      ...
      correctAnswers: [
        { id: 1, text: 'A function combined with its lexical environment', answer: 2 }
      ]
    },
    {
      course_id: 'C103',
