...
const CourseCard = ({props, progress}) => {
    return (
        <div
            className="group flex max-h-64 w-full rounded-md bg-secondary-color4/50 px-2 py-2 backdrop-blur duration-200 hover:scale-105 hover:shadow-md sm:h-auto sm:max-h-none sm:w-64 sm:flex-col sm:px-4">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:flex-col sm:items-start sm:pt-2">
                <div
                    className="line-clamp-2 w-full text-lg font-medium transition group-hover:text-primary sm:min-w-16 md:text-base">
                    Title
                </div>
                ...
                { progress !== null ? (
                    <div className="flex items-center w-full">Complete %</div>
                ) :
