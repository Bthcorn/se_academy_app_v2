        ...
        <div className="flex flex-col gap-2 rounded-md px-4 py-8">
          <div className="flex h-auto w-full flex-wrap gap-2 rounded-md bg-secondary/60 px-2 py-3">
            ...
            <div className="inline-flex items-center gap-2">
              <Sprout size={20} />
              <span>level:</span>
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary-color5/20 text-secondary-color5">
                3
              </span>
            </div>
            <div className="inline-flex items-center gap-2">
              ...
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary-color3/20 text-secondary-color3">
                3
              </span>
              <span>hrs</span>
            </div>
          ...
          <div className="flex h-auto w-full flex-col gap-2 rounded-md bg-secondary/60 px-2 py-3">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary-color2/20 text-secondary-color2">
                  100
                </span>
              </div>
              <div className="flex items-center gap-2">
