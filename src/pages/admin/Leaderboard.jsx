...
export default function Leaderboard() {
  ...
  return (
    <div className="p-6 w-full">
      <Leaderboard_component users={sampleUserData} />
    </div>
  );
}
